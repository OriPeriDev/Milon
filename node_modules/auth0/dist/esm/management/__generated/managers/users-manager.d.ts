 ...
 *
 */
export declare class UsersManager extends BaseAPI {
    /**
     * Deletes all authentication methods for the given user
     *
     * @throws {RequiredError}
     */
    deleteAuthenticationMethods(requestParameters: DeleteAuthenticationMethodsRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     * Deletes an authentication method by ID
     *
     * @throws {RequiredError}
     */
    deleteAuthenticationMethod(requestParameters: DeleteAuthenticationMethodsByAuthenticationMethodIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     * Delete All Authenticators
     *
     * @throws {RequiredError}
     */
    deleteAllAuthenticators(requestParameters: DeleteAuthenticatorsRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteMultifactorProvider(requestParameters: DeleteMultifactorByProviderRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    deletePermissions(requestParameters: DeletePermissionsOperationRequest, bodyParameters: DeletePermissionsRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteRefreshTokens(requestParameters: DeleteRefreshTokensForUserRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteSessions(requestParameters: DeleteSessionsForUserRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    unlink(requestParameters: DeleteUserIdentityByUserIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<DeleteUserIdentityByUserId200ResponseInner>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteRoles(requestParameters: DeleteUserRolesOperationRequest, bodyParameters: DeleteUserRolesRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     * Delete a user.
     * Delete a User
     *
     * @throws {RequiredError}
     */
    delete(requestParameters: DeleteUsersByIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     * Gets a list of authentication methods
     *
     * @throws {RequiredError}
     */
    getAuthenticationMethods(requestParameters: GetAuthenticationMethodsRequest & {
        include_totals: true;
    }, initOverrides?: InitOverride): Promise<ApiResponse<GetAuthenticationMethods200ResponseOneOf>>;
    getAuthenticationMethods(requestParameters?: GetAuthenticationMethodsRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<GetAuthenticationMethods200ResponseOneOfInner>>>;
    /**
     * Gets an authentication method by ID.
     *
     * @throws {RequiredError}
     */
    getAuthenticationMethod(requestParameters: GetAuthenticationMethodsByAuthenticationMethodIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<GetAuthenticationMethods200ResponseOneOfInner>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getEnrollments(requestParameters: GetEnrollmentsRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<UserEnrollment>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getLogs(requestParameters: GetLogsByUserRequest & {
        include_totals: true;
    }, initOverrides?: InitOverride): Promise<ApiResponse<GetLogs200ResponseOneOf>>;
    getLogs(requestParameters?: GetLogsByUserRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<Log>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getPermissions(requestParameters: GetPermissionsRequest & {
        include_totals: true;
    }, initOverrides?: InitOverride): Promise<ApiResponse<GetPermissions200ResponseOneOf>>;
    getPermissions(requestParameters?: GetPermissionsRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<GetPermissions200ResponseOneOfInner>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getRefreshTokens(requestParameters: GetRefreshTokensForUserRequest, initOverrides?: InitOverride): Promise<ApiResponse<GetRefreshTokensForUser200Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSessions(requestParameters: GetSessionsForUserRequest, initOverrides?: InitOverride): Promise<ApiResponse<GetSessionsForUser200Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getUserOrganizations(requestParameters: GetUserOrganizationsRequest & {
        include_totals: true;
    }, initOverrides?: InitOverride): Promise<ApiResponse<GetOrganizations200ResponseOneOf>>;
    getUserOrganizations(requestParameters?: GetUserOrganizationsRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<GetOrganizations200ResponseOneOfInner>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getRoles(requestParameters: GetUserRolesRequest & {
        include_totals: true;
    }, initOverrides?: InitOverride): Promise<ApiResponse<GetOrganizationMemberRoles200ResponseOneOf>>;
    getRoles(requestParameters?: GetUserRolesRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<GetOrganizationMemberRoles200ResponseOneOfInner>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getAll(requestParameters: GetUsersRequest & {
        include_totals: true;
    }, initOverrides?: InitOverride): Promise<ApiResponse<GetUsers200ResponseOneOf>>;
    getAll(requestParameters?: GetUsersRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<GetUsers200ResponseOneOfInner>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    get(requestParameters: GetUsersByIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<GetUsers200ResponseOneOfInner>>;
    /**
     * Updates an authentication method.
     *
     * @throws {RequiredError}
     */
    updateAuthenticationMethod(requestParameters: PatchAuthenticationMethodsByAuthenticationMethodIdOperationRequest, bodyParameters: PatchAuthenticationMethodsByAuthenticationMethodIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<PutAuthenticationMethods200ResponseInner>>;
    /**
     * Update a user.
     *
     ...
     * @throws {RequiredError}
     */
    update(requestParameters: PatchUsersByIdRequest, bodyParameters: UserUpdate, initOverrides?: InitOverride): Promise<ApiResponse<GetUsers200ResponseOneOfInner>>;
    /**
     ...
     * @throws {RequiredError}
     */
    createAuthenticationMethod(requestParameters: PostAuthenticationMethodsOperationRequest, bodyParameters: PostAuthenticationMethodsRequest, initOverrides?: InitOverride): Promise<ApiResponse<PostAuthenticationMethods201Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    link(requestParameters: PostIdentitiesOperationRequest, bodyParameters: PostIdentitiesRequest, initOverrides?: InitOverride): Promise<ApiResponse<Array<UserIdentity>>>;
    /**
     ...
     * @throws {RequiredError}
     */
    invalidateRememberBrowser(requestParameters: PostInvalidateRememberBrowserRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    assignPermissions(requestParameters: PostPermissionsOperationRequest, bodyParameters: PostPermissionsRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    regenerateRecoveryCode(requestParameters: PostRecoveryCodeRegenerationRequest, initOverrides?: InitOverride): Promise<ApiResponse<PostRecoveryCodeRegeneration200Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    assignRoles(requestParameters: PostUserRolesOperationRequest, bodyParameters: PostUserRolesRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    create(bodyParameters: UserCreate, initOverrides?: InitOverride): Promise<ApiResponse<GetUsers200ResponseOneOfInner>>;
    /**
     * Updates all authentication methods by replacing them with the given ones.
     *
     * @throws {RequiredError}
     */
    updateAuthenticationMethods(requestParameters: PutAuthenticationMethodsRequest, bodyParameters: Array<PutAuthenticationMethodsRequestInner>, initOverrides?: InitOverride): Promise<ApiResponse<Array<PutAuthenticationMethods200ResponseInner>>>;
}
export {};
